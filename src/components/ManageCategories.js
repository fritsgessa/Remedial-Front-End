...
class ManageCategories extends Component {
    ...
    getCategoryList = () => {
        axios.get('http://localhost:2019/category-list')
        .then((res) => {
    ...
    onBtnAddClick = () => {
        ...
        if(nama === ''){
            ...
            axios.post('http://localhost:2019/category-add', {
                nama
            }).then((res) => {
                this.getCategoryList();
            }).catch((err) => {
    ...
    onBtnDeleteClick = (id) => {
        if(window.confirm('Yakin nih bro?')){
            axios.post('http://localhost:2019/category-delete/' + id)
                .then((res) => {
                    this.getCategoryList();
                }).catch((err) => {
                    console.log(err)
    ...
    onBtnSaveClick = (id) => {
        ...
        console.log(nama)
        axios.post('http://localhost:2019/category-edit/' + id, {
            nama
        }).then((res) => {
